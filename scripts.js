...
function handleTabletChange768px(e) {
  if (e.matches) {
    agentMovie.setAttribute("width", "340");
    agentMovie.setAttribute("height", "271");
  }
  else {
    agentMovie.setAttribute("width", "660");
    agentMovie.setAttribute("height", "515");
...
mediaQuery768px.addListener(handleTabletChange768px);
handleTabletChange768px(mediaQuery768px);